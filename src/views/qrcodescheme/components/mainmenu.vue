...
export default {
  ...
  data() {
    return {
      menuall:[
        {icon:'',topic:'เพิ่ม',func:'เพิ่ม',suptopic:'เพิ่มอุปกรณ์จากใบเบิกเข้าคลัง',ishow:false},
        {icon:'',topic:'ลด',func:'ลด',suptopic:'ตรวจสอบจำนวนอุปกรณ์คงเหลือ',ishow:false},
        {icon:'',topic:'ย้าย',func:'ย้าย',suptopic:'เบิกของขึ้นรถ',ishow:false},
        {icon:'',topic:'เชคยานพาหนะ',func:'เชคยานพาหนะ',suptopic:'ตรวจสอบยานพาหนะ',ishow:false},
        {icon:'',topic:'เชคเครื่องมือ',func:'เชคเครื่องมือ',suptopic:'ตรวจสอบเครื่องมือ',ishow:false},
        {icon:'',topic:'สรุป',func:'สรุป',suptopic:'สรุปรายการอุปกรณ์คงเหลือ',ishow:false},
        {icon:'',topic:'แก้ไข',func:'แก้ไข',suptopic:'ตั้งค่าเริ่มต้น',ishow:false},
        {icon:'',topic:'รายงานการตรวจสภาพรถ',func:'รายงานการตรวจสภาพรถ',suptopic:'รายงานการตรวจสภาพรถ',ishow:false},
      ],
      theme: false,
      avatar_wh: '',
      componentKey: 0,
  ...
  methods: {
    ...
    querypicture(){
      ...
      this.menuall[7].icon = picon_edit
