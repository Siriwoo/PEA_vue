  ...
  <div v-show="value" class="vue-image-crop-upload">
    <div class="vicp-wrap">
      ...
      <div v-if="step == 2" class="vicp-step2">
        ...
        <div class="vicp-operate">
          <el-button type="primary" @click="setStep(1)" @mousedown="ripple" :disabled="flagloading">{{ lang.btn.back }}</el-button>
          <el-button type="primary" @click="prepareUpload" @mousedown="ripple" :loading="flagloading">{{ lang.btn.save }}</el-button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    prepareUpload() {
      ...
      var filename = 'avatar_'+JSON.parse(getUserData()).name
      //console.log(filename)
      var file = this.dataURItoBlob(createImgUrl);
      this.uploadSinglepic(file,filename,'avatar')
